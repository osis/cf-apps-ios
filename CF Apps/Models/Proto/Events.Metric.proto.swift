...
public extension Events {
    ...
    final public class ValueMetric : GeneratedMessage {
        ...
        public fileprivate(set) var unit:String = ""
    ...
    final public class CounterEvent : GeneratedMessage {
        ...
        public fileprivate(set) var delta:UInt64 = UInt64(0)
        ...
        public fileprivate(set) var total:UInt64 = UInt64(0)
