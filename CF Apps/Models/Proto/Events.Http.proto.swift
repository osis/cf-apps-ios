...
public extension Events {
    ...
    public enum PeerType:Int32, CustomDebugStringConvertible, CustomStringConvertible, Hashable {
        ...
        public static func fromString(str:String) throws -> Events.PeerType {
            switch str {
            case "Client":    return .client
            case "Server":    return .server
    ...
    //// HTTP method.
    public enum Method:Int32, CustomDebugStringConvertible, CustomStringConvertible, Hashable {
        case `get` = 1
        case post = 2
        case put = 3
        case delete = 4
        ...
        public static func fromString(str:String) throws -> Events.Method {
            switch str {
            case "GET":    return .`get`
            case "POST":    return .post
            case "PUT":    return .put
    ...
    final public class HttpStartStop : GeneratedMessage {
        ...
        public fileprivate(set) var uri:String = ""
        ...
        public fileprivate(set) var instanceIndex:Int32 = Int32(0)
        public fileprivate(set) var hasInstanceIndex:Bool = false

        //// ID of the application instance.
        public fileprivate(set) var instanceId:String = ""
        ...
        final public class Builder : GeneratedMessageBuilder {
            ...
            class override public func decodeToBuilder(jsonMap:Dictionary<String,Any>) throws -> Events.HttpStartStop.Builder {
                ...
                if let jsonValuePeerType = jsonMap["peerType"] as? String {
                    resultDecodedBuilder.peerType = try Events.PeerType.fromString(str: jsonValuePeerType)
                }
                if let jsonValueMethod = jsonMap["method"] as? String {
                    resultDecodedBuilder.method = try Events.Method.fromString(str: jsonValueMethod)
                }
