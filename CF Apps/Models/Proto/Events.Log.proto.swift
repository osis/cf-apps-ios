    ...
    final public class LogMessage : GeneratedMessage {
        ...
        public static func == (lhs: Events.LogMessage, rhs: Events.LogMessage) -> Bool {
            ...
            public enum MessageType:Int32, CustomDebugStringConvertible, CustomStringConvertible, Hashable {
                ...
                public static func fromString(str:String) throws -> Events.LogMessage.MessageType {
                    switch str {
                    case "OUT":    return .out
                    case "ERR":    return .err
        ...
        public fileprivate(set) var sourceType:String = ""
        public fileprivate(set) var hasSourceType:Bool = false

        //// Instance that emitted the message.
        public fileprivate(set) var sourceInstance:String = ""
        ...
        final public class Builder : GeneratedMessageBuilder {
            ...
            class override public func decodeToBuilder(jsonMap:Dictionary<String,Any>) throws -> Events.LogMessage.Builder {
                ...
                if let jsonValueMessageType = jsonMap["messageType"] as? String {
                    resultDecodedBuilder.messageType = try Events.LogMessage.MessageType.fromString(str: jsonValueMessageType)
                }
