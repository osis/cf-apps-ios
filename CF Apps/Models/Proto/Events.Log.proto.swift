...
public func == (lhs: Events.LogMessage, rhs: Events.LogMessage) -> Bool {
  if (lhs === rhs) {
    return true
  }
...
public extension Events {
  ...
  final public class LogMessage : GeneratedMessage, GeneratedMessageProtocol {
    ...
    public private(set) var messageType:Events.LogMessage.MessageType = Events.LogMessage.MessageType.Out
    ...
    public class func parseArrayDelimitedFromInputStream(input:NSInputStream) throws -> Array<Events.LogMessage> {
    ...
    public class func parseFromDelimitedFromInputStream(input:NSInputStream) throws -> Events.LogMessage? {
      return try Events.LogMessage.Builder().mergeDelimitedFromInputStream(input)?.build()
    }
    public class func parseFromData(data:NSData) throws -> Events.LogMessage {
      return try Events.LogMessage.Builder().mergeFromData(data, extensionRegistry:Events.LogRoot.sharedInstance.extensionRegistry).build()
    }
    public class func parseFromData(data:NSData, extensionRegistry:ExtensionRegistry) throws -> Events.LogMessage {
      return try Events.LogMessage.Builder().mergeFromData(data, extensionRegistry:extensionRegistry).build()
    }
    public class func parseFromInputStream(input:NSInputStream) throws -> Events.LogMessage {
      return try Events.LogMessage.Builder().mergeFromInputStream(input).build()
    }
    public class func parseFromInputStream(input:NSInputStream, extensionRegistry:ExtensionRegistry) throws -> Events.LogMessage {
      return try Events.LogMessage.Builder().mergeFromInputStream(input, extensionRegistry:extensionRegistry).build()
    }
    public class func parseFromCodedInputStream(input:CodedInputStream) throws -> Events.LogMessage {
      return try Events.LogMessage.Builder().mergeFromCodedInputStream(input).build()
    }
    public class func parseFromCodedInputStream(input:CodedInputStream, extensionRegistry:ExtensionRegistry) throws -> Events.LogMessage {
      return try Events.LogMessage.Builder().mergeFromCodedInputStream(input, extensionRegistry:extensionRegistry).build()
    }
    ...
    public func toBuilder() throws -> Events.LogMessage.Builder {
      return try Events.LogMessage.builderWithPrototype(self)
    }
    public class func builderWithPrototype(prototype:Events.LogMessage) throws -> Events.LogMessage.Builder {
      return try Events.LogMessage.Builder().mergeFrom(prototype)
    }
    ...
    override public func classMetaType() -> GeneratedMessage.Type {
        return Events.LogMessage.self
    }
    //Meta information declaration end

    final public class Builder : GeneratedMessageBuilder {
      private var builderResult:Events.LogMessage = Events.LogMessage()
      ...
      public func setMessage_(value:NSData) -> Events.LogMessage.Builder {
        self.message_ = value
        return self
      }
      public func clearMessage_() -> Events.LogMessage.Builder{
        ...
        public func setMessageType(value:Events.LogMessage.MessageType) -> Events.LogMessage.Builder {
      ...
      public func setTimestamp(value:Int64) -> Events.LogMessage.Builder {
      ...
      public func setAppId(value:String) -> Events.LogMessage.Builder {
        self.appId = value
        return self
      }
      ...
      public func setSourceType(value:String) -> Events.LogMessage.Builder {
      ...
      public func setSourceInstance(value:String) -> Events.LogMessage.Builder {
      ...
      public override func clear() -> Events.LogMessage.Builder {
        builderResult = Events.LogMessage()
        return self
      }
      public override func clone() throws -> Events.LogMessage.Builder {
        return try Events.LogMessage.builderWithPrototype(builderResult)
      }
      public override func build() throws -> Events.LogMessage {
      ...
      public override func mergeFromCodedInputStream(input:CodedInputStream) throws -> Events.LogMessage.Builder {
           return try mergeFromCodedInputStream(input, extensionRegistry:ExtensionRegistry())
      }
      public override func mergeFromCodedInputStream(input:CodedInputStream, extensionRegistry:ExtensionRegistry) throws -> Events.LogMessage.Builder {
